...
This Fork has been modified to support the new M1 chips on Apple devices. It is tracking the `release` branch which is ours, that fixes some issues with pulling using their tags. This branch will always contain the latest updates.
